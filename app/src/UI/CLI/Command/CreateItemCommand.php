...
use App\Application\Controller\PostItem\PostItemSymfonyCliController;
...
class CreateItemCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $postItemSymfonyCliViewModel = $this->postItemController->createItem($postItemRequestSymfonyCli);
